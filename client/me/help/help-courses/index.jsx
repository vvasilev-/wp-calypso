	...
	return [
		{
			...
			description: i18n.translate(
				'In this 60-minute session with our Happiness Engineers, we will provide a foundation for ' +
				'making sure that your site meets current SEO standards. We\'ll also discuss how to use ' +
				'fundamental tools like Google Analytics and Webmaster Tools on your site. You\'ll leave with ' +
				'a plan for optimizing your site for search traffic and an overview of basic tactics ' +
